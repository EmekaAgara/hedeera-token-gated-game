    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto text-left md:text-center">
        ...
        <motion.div
          ...
          className="mb-4"
        >
          <h1 className="text-3xl md:text-8xl font-medium mb-3">
            <span className="">Play to Earn On</span>
            <span className="text-indigo-500"> XBag 💰 </span>
          </h1>
          <p className="text-xs text-gray-300 mt-5 my-4 max-w-2xl mx-auto">
            Connect your wallet and enjoy a sleeek gaming experience on Hedera.
            Play, earn tokens, and collect unique NFTs in our immersive 3D
            world.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-row gap-4 justify-start sm:justify-center items-start md:items-center mb-12"
        >
          <motion.button
            ...
            className="px-8 py-4 bg-indigo-800 rounded font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
          ...
          <Link to="/marketplace">
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border border-gray-500 text-hedera-purple hover:bg-hedera-purple hover:text-white rounded font-semibold text-sm transition-all"
            >
              Visit Marketplace
            </motion.div>
          </Link>
        ...
        <div className="">
          <Spline
            scene="https://prod.spline.design/m1dOQAvVe5vTyvcO/scene.splinecode"
            onLoad={(spline) => {
          ...
          />
          {/* <Spline scene="https://prod.spline.design/SvTXJ4ScVCNYDtbk/scene.splinecode" /> */}
        </div>
